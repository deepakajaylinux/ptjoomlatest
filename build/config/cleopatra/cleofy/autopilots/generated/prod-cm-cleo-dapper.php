...
class AutoPilotConfigured extends AutoPilot {
    ...
    private function setSteps() {
        ...
        $this->steps =
            array(
                array ( "Logging" => array( "log" => array( "log-message" => "Lets begin Configuration of Cleo and Dapper on environment prod"),),),
                ...
                array ( "Logging" => array( "log" => array( "log-message" => "Configuring Cleo and Dapper on environment prod complete"),),),
