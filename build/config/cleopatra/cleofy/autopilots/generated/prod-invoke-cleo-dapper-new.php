    ...
    $this->steps =
        array(
            array ( "Logging" => array( "log" => array(
                "log-message" => "Lets begin invoking Configuration of a new Cleo and Dapper on environment prod"
            ), ), ),
            array ( "Logging" => array( "log" => array(
            ...
            array ( "Logging" => array( "log" => array(
                "log-message" => "Invoking a new Cleo and Dapper on environment prod complete"
            ), ) ),
        );
...
sudo cleopatra autopilot execute --autopilot-file="/tmp/prod-cm-cleo-dapper.php"
rm /tmp/prod-cm-cleo-dapper.php
SSHDATA;
        return $sshData ;
    }
